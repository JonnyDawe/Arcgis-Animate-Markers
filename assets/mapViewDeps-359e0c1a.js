import{Y as re,Z as De,U as Y,$ as Ue,u as se,a0 as T,r as B,a1 as Ge,a2 as Ie,a3 as He,a4 as J,a5 as ae,a6 as Q,a7 as qe,a8 as ue,a9 as We,aa as Ve,ab as je,ac as Xe,l as N,ad as Ye,ae as he,af as Ke,X as Je,o as Qe,k as ce,ag as Ze,ah as et,ai as tt,aj as _e,ak as it,al as rt,am as pe,an as st,ao as at,ap as nt,aq as Z,ar as ot,as as fe,at as lt,au as dt}from"./vendor-11df6bed.js";import{i as ut,C as ht,b as ct,e as me,r as _t,t as pt,a as ft,_ as mt,J as gt,c as vt,d as bt,f as Tt}from"./MagnifierPrograms-0598c518.js";import{u as as,y as ns}from"./MagnifierPrograms-0598c518.js";import{c as xt}from"./imageutils-c791e8b8.js";import{t as wt,i as yt,o as ge,h as ve,r as Et}from"./Container-de38d099.js";import{n as Rt}from"./BufferPool-ca91d767.js";import{T as S,E as q,S as ee}from"./color-d8d2550b.js";import{t as Bt,n as H,a as j,w as z,m as Ft}from"./WGLContainer-96c991fa.js";import{L as P}from"./enums-fb086c25.js";import{e as Ot,a as K}from"./ProgramTemplate-7ff05b5e.js";import{n as G}from"./programUtils-f6fa85b4.js";import{f as ne,E as oe,x as A,s as Mt}from"./VertexArrayObject-c3d25870.js";import{R as g,E as V,F as le,O as te,I as ze,L as x,C as be,M as O,P as f,G as y,D as M,Y as D,V as U,B as Pt}from"./enums-64ab819c.js";import{o as Te,I as Ct}from"./RenderingContext-a4bbc94f.js";import{b as St,x as At,N as Dt,B as Ut,C as It,I as W,J as zt,Y as Ne,O as xe}from"./definitions-19bfb61c.js";import{t as we}from"./VertexElementDescriptor-2925c6af.js";import{E as k}from"./Texture-2f24cda9.js";import{a as ls}from"./GraphicsView2D-5bd192b2.js";import{i as us}from"./GraphicContainer-fecfc508.js";import{t as ye}from"./requestImageUtils-ea6a6af0.js";import"./ExpandedCIM-1cbb5011.js";import"./BidiEngine-836b7ef6.js";import"./GeometryUtils-53652037.js";import"./enums-55085e26.js";import"./MaterialKey-c121b999.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-0e6c7a03.js";import"./floatRGBA-f4174ddc.js";import"./rasterizingUtils-3fd5237f.js";import"./GeometryUtils-dd03fc25.js";import"./Matcher-b336d0ac.js";import"./visualVariablesUtils-bc5c2c3e.js";import"./visualVariablesUtils-c63c72d7.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-e8852853.js";import"./earcut-61f7b102.js";import"./CircularArray-84e0aaec.js";import"./webgl-debug-b1f7a2c5.js";import"./ComputedAttributeStorage-67b26338.js";import"./arcadeTimeUtils-3de6b6bd.js";import"./executionError-fb3f283a.js";import"./centroid-d3ae0e65.js";import"./utils-6f2426a8.js";import"./StyleDefinition-fbc907c2.js";import"./config-1337d16e.js";import"./NestedMap-1b5db22e.js";import"./OrderIndependentTransparency-e1b3a745.js";import"./basicInterfaces-b7051eb1.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-480575f5.js";import"./projectionSupport-3d541642.js";import"./json-48e3ea08.js";import"./AttributeStoreView-8bab5de7.js";import"./TiledDisplayObject-aee2a543.js";import"./schemaUtils-e883a2a2.js";import"./util-5a4e1580.js";import"./BaseGraphicContainer-ae6cdfd4.js";import"./FeatureContainer-3432dbbd.js";import"./TileContainer-c8ed73ab.js";import"./vec3f32-ad1dc57f.js";async function Nt(l,e){const t=ut(l);if(t instanceof Error)throw t;await t.createImages(),re(e);const{frames:i,width:r,height:a}=t,s=document.createElement("canvas");s.width=r,s.height=a;const n=s.getContext("2d",{willReadFrequently:!0}),d=[],u=[];for(const o of i){u.push(De(o.delay||100));const h=o.imageElement;o.blendOp===0?n.globalCompositeOperation="copy":n.globalCompositeOperation="source-over";const c=o.disposeOp===2?n.getImageData(o.left,o.top,o.width,o.height):void 0;n.drawImage(h,o.left,o.top);const p=n.getImageData(0,0,r,a);d.push(p),o.disposeOp===0||(o.disposeOp===1?n.clearRect(o.left,o.top,o.width,o.height):o.disposeOp===2&&n.putImageData(c,o.left,o.top))}return{frameDurations:u,getFrame:o=>d[o],width:r,height:a}}const Lt=[137,80,78,71,13,10,26,10];function $t(l){const e=new Uint8Array(l);return!Lt.some((t,i)=>t!==e[i])}function kt(l){if(!$t(l))return!1;const e=new DataView(l),t=new Uint8Array(l);let i,r=8;do{const a=e.getUint32(r);if(i=String.fromCharCode.apply(String,Array.prototype.slice.call(t.subarray(r+4,r+8))),i==="acTL")return!0;r+=12+a}while(i!=="IEND"&&r<t.length);return!1}async function Gt(l,e){const t=ht(l),i=ct(t,!0),{width:r,height:a}=t.lsd,s=document.createElement("canvas");s.width=r,s.height=a;const n=s.getContext("2d",{willReadFrequently:!0}),d=[],u=[];for(const o of i){u.push(De(o.delay||100));const h=new ImageData(o.patch,o.dims.width,o.dims.height),c=xt(h),p=o.disposalType===3?n.getImageData(o.dims.left,o.dims.top,o.dims.width,o.dims.height):void 0;n.drawImage(c,o.dims.left,o.dims.top);const m=n.getImageData(0,0,r,a);d.push(m),o.disposalType===1||(o.disposalType===2?n.clearRect(o.dims.left,o.dims.top,o.dims.width,o.dims.height):o.disposalType===3&&n.putImageData(p,o.dims.left,o.dims.top))}return{frameDurations:u,getFrame:o=>d[o],width:r,height:a}}const Ht=[71,73,70];function qt(l){const e=new Uint8Array(l);return!Ht.some((t,i)=>t!==e[i])}function Wt(l){if(!qt(l))return!1;const e=new DataView(l),t=e.getUint8(10);let i=13+(128&t?3*2**(1+(7&t)):0),r=0,a=!1;for(;!a;){switch(e.getUint8(i++)){case 33:if(!s())return!1;break;case 44:n();break;case 59:a=!0;break;default:return!1}if(r>1)return!0}function s(){switch(e.getUint8(i++)){case 249:d();break;case 1:u();break;case 254:o();break;case 255:h();break;default:return!1}return!0}function n(){r++,i+=8;const p=e.getUint8(i++);i+=128&p?3*2**(1+(7&p)):0,i++,c()}function d(){i++,i+=4,c()}function u(){r++,i++,i+=12,c()}function o(){c()}function h(){i++,i+=8,i+=3,c()}function c(){let p;for(;p=e.getUint8(i++);)i+=p}return!1}let Vt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(a=>({width:a.width,height:a.height})):(r=Xt(e,t),this._inFlightResourceMap.set(e,r),r.then(a=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,a),{width:a.width,height:a.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}};async function jt(l,e){const t=window.URL.createObjectURL(l);try{const{data:i}=await Y(t,{...e,responseType:"image"});return i}catch(i){throw Ue(i)?i:new se("mapview-invalid-resource",`Could not fetch requested resource at ${t}`)}finally{window.URL.revokeObjectURL(t)}}async function Xt(l,e){const{arrayBuffer:t,mediaType:i}=await Yt(l,e),r=i==="image/png";return i==="image/gif"&&Wt(t)?Gt(t):r&&kt(t)?Nt(t,e):jt(new Blob([t],{type:i}),e)}async function Yt(l,e){let t;const i=";base64,";if(l.includes(i)){const r=l.indexOf(i),a=l.indexOf(i)+i.length,s=l.substring(a),n=atob(s),d=new Uint8Array(n.length);for(let u=0;u<n.length;u++)d[u]=n.charCodeAt(u);t={arrayBuffer:d.buffer,mediaType:l.substring(0,r).replace("data:","")}}else try{const r=await Y(l,{responseType:"array-buffer",...e});t={arrayBuffer:r.data,mediaType:r.getHeader("Content-Type")}}catch(r){if(!Ue(r))throw new se("mapview-invalid-resource",`Could not fetch requested resource at ${l}`)}return t}const Kt={background:{"background.frag":`#ifdef PATTERN
